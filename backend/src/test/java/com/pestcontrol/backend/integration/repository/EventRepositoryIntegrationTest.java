...
class EventRepositoryIntegrationTest {
    ...
    void getEvents_autoTransitionsPastScheduledEvents() {
        // An event whose end time is already in the past should not appear in the public listing
    ...
    void updateEvent_whenTimeChanges_sendsNotificationEmails() {
        ...
        UpdateEventRequest request = buildValidUpdateRequest();
        request.setStartDateTime(OffsetDateTime.now().plusDays(15)); // different time
